...
public class ResponseToOrdersTest {
  ...
  public void testSnapshotPositive() {
    ...
    var snapshotResponse = Level2SnapshotResponse.builder().productId("XYZ").type("snapshot")
  ...
  public void testUpdatePositive() {
    var changes = List.of(List.of("buy", "10102.55", "0.57753524"),
        List.of("sell", "10101.10", "0.45054140"));

    var updateNotification = Level2UpdateNotification.builder().productId("XYZ").type("l2update")
        .time(LocalDateTime.now()).changes(changes).build();
